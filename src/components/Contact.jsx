  ...
  return (
    ...
    to-gray-800 p-4 text-white'>
        ...
        mx-auto h-full'>
            ...
            <p className='py-8'>Kindly submit the form below to get in touch with me</p>
            </div>
        
        <div className='flex justify-center items-center'>
            <form action='https://getform.io/f/b0a98585-d3c8-4fbc-b228-2c9d97c0a7f6'
            method="POST" className='flex flex-col w-full md:1/2'>
                <input type="text" name='name' placeholder='Enter Your Name' className='
                p-2 bg-tranparent border-2 rounded-md text-white focus:outline-none'  />

                  <input type="text" name='email' placeholder='Enter Your Email' className='
                my-4 p-2 bg-tranparent border-2 rounded-md text-white focus:outline-none'  />
